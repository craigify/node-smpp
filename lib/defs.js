...
var consts = {
	...
	// CM 2019-07-03
	// We should be using 0x00 for all texts that are not UCS2. This library breaks when the encoding
	// is set to 0 because there is not an encoder for 'SMSC_DEFAULT'. The solution was to change the
	// value for ASCII to 0. GSM7 practically is ASCII.
	ENCODING: {
		/* SMSC_DEFAULT:       0x00, */
		ASCII:              0x00,
		IA5:                0x01,
